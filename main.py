...
if __name__ == "__main__":
    # GMMData PeaksData SwissRollData
    dataset_name = 'SwissRollData'
    Ct, Cv, Yt, Yv = utils.get_data('SwissRollData')
    ...
    #
    # print_result(dataset_name, train_success_rate, validation_success_rate, learning_rate, batch_size)
    # plot_results(epoch_data, train_rate_data, validation_rate_data, dataset_name)
    ...
    plot_results(epoch_data, train_rate_data, validation_rate_data, "NN " + dataset_name)
    # running_on_mnist_data_set()